...
$rowsByMenu = [
    ['name'=>'Chicken Teriyaki Rice Bowl','category'=>'Food','total_sold'=>86,'orders'=>75,'revenue'=>'Rp 2.580.000','pct'=>'22%'],
    ['name'=>'Chicken Teriyaki Rice Bowl','category'=>'Food','total_sold'=>86,'orders'=>75,'revenue'=>'Rp 2.580.000','pct'=>'22%'],
    ['name'=>'Chicken Teriyaki Rice Bowl','category'=>'Food','total_sold'=>86,'orders'=>75,'revenue'=>'Rp 2.580.000','pct'=>'22%'],
    ['name'=>'Chicken Teriyaki Rice Bowl','category'=>'Food','total_sold'=>86,'orders'=>75,'revenue'=>'Rp 2.580.000','pct'=>'22%'],
    ['name'=>'Chicken Teriyaki Rice Bowl','category'=>'Food','total_sold'=>86,'orders'=>75,'revenue'=>'Rp 2.580.000','pct'=>'22%'],
...
$rowsByStaff = [
    ['name'=>'Miguela Veloso','role'=>'Cashier','orders_handled'=>62,'items_sold'=>108,'revenue'=>'Rp 3.240.000','avg'=>'Rp. 52.000'],
    ['name'=>'Miguela Veloso','role'=>'Cashier','orders_handled'=>62,'items_sold'=>108,'revenue'=>'Rp 3.240.000','avg'=>'Rp. 52.000'],
    ['name'=>'Miguela Veloso','role'=>'Cashier','orders_handled'=>62,'items_sold'=>108,'revenue'=>'Rp 3.240.000','avg'=>'Rp. 52.000'],
    ['name'=>'Miguela Veloso','role'=>'Cashier','orders_handled'=>62,'items_sold'=>108,'revenue'=>'Rp 3.240.000','avg'=>'Rp. 52.000'],
    ['name'=>'Miguela Veloso','role'=>'Cashier','orders_handled'=>62,'items_sold'=>108,'revenue'=>'Rp 3.240.000','avg'=>'Rp. 52.000'],
    ...
    <div style="background:#fff; border-radius:1rem; border:1.5px solid #EDE8E0; overflow:hidden;">
        ...
        <div x-show="tab==='menu'" x-cloak>
            <table class="report-table">
                <thead>
                    <tr>
                        @foreach(['Menu Name','Category','Total Sold','Orders','Revenue','% of Sales'] as $col)
                        <th>
                            {{ $col }}
                            <span class="sort-icon">
                                <span class="up"></span>
        ...
        <div x-show="tab==='staff'" x-cloak>
            <table class="report-table">
                <thead>
                    <tr>
                        @foreach(['Staff Name','Role','Orders Handled','Items Sold','Revenue','Avg. Order Value'] as $col)
                        <th>
                            {{ $col }}
                            <span class="sort-icon">
                                <span class="up"></span>
